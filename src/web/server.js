...
app.post('/config/env', (req, res) => {
  res.set('Cache-Control', 'no-cache').json({
    ...
    REACT_APP_ALWAYS_SHOW_LESSON_TREE:
      process.env.REACT_APP_ALWAYS_SHOW_LESSON_TREE || false,
    ...
    REACT_APP_ENABLE_WXCODE:
      process.env.REACT_APP_ENABLE_WXCODE !== undefined
        ? process.env.REACT_APP_ENABLE_WXCODE === 'true'
        : true,
