...
class TestConfigInitialization:
    ...
    def test_init_with_valid_flask_app(self, monkeypatch):
        ...
        app.logger.info.assert_called_with("Environment configuration validated successfully")
...
class TestConfigGetItem:
    ...
    def test_getitem_fallback_to_parent(self, monkeypatch):
        ...
        with patch.object(config.enhanced, 'get', side_effect=EnvironmentConfigError("Unknown")):
